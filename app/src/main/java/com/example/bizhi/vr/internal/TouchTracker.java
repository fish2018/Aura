 ...
 */
public final class TouchTracker extends GestureDetector.SimpleOnGestureListener
  ...
  public TouchTracker(
      Context context, Listener listener, float pxPerDegrees, float initialRollRadians) {
    this.listener = listener;
    this.pxPerDegrees = pxPerDegrees;
    gestureDetector = new GestureDetector(context, this);
    roll = initialRollRadians;
  }
